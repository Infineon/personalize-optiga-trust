...
* [Issue a certificate from Amazon Root CA for AWS IoT](using-amazon-root-ca)
...
* [Issue a certificate from a user-owned CA for AWS IoT](using-amazon-and-self-signed-ca)
