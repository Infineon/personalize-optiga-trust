...
* Option 1. [Register a certificate manually](https://docs.aws.amazon.com/iot/latest/developerguide/manual-cert-registration.html). You can use for this your certificate `workspace/<name-of-your-csr-eg-47478ea636328de8488a50236e79aa40720afc6f>.pem` and the corresponding CA certificate `workspace/root/ca/certs/ca.cert.pem`. 
If you would like just to register your newly generated certificate with AWS CLI you can do the following: 
```console
#Register the certificate with AWS IoT. Pass in the newly generated device certificate and the CA certificate to the CLI command.
$ aws iot register-certificate \
--set-as-active \
--certificate-pem file://<name-of-your-csr-eg-47478ea636328de8488a50236e79aa40720afc6f>.pem \
--ca-certificate-pem file://root/ca/certs/ca.cert.pem \
--query certificateArn > optiga.aws_arn
```

After this you can continue with the next [step](step-4-attach-aws-thing-and-policy.md).
